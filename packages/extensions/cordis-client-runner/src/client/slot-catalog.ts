...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.enhanced-trajectory.images',
    kind: 'single',
    scope: 'session',
    summary: 'Authorized image rendering for the selected parent or nested enhanced record.',
    doc: 'Authorized image rendering for the selected parent or nested enhanced record.',
    registerOptions: [],
    ownerProps: [
    ...
    source: 'packages/client/ui-trajectory/src/client/trajectory-contract.ts:100',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-trajectory EnhancedTrajectoryView id \'enhanced-trajectory\'',
    ],
    replaceRisk: 'none',
