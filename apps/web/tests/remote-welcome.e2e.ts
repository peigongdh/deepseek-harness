// Authenticated non-loopback browsers persist welcome acknowledgement across reloads.
...
describe.skipIf(MODE === 'record')('web e2e: remote welcome notice', () => {
  ...
  it('persists acknowledgement and keeps the notice dismissed after reload', async () => {
